...
def train_minibatch(mainDQN: DQN, targetDQN: DQN, train_batch: list) -> float:
    ...
    Q_Global = reward_array + discount_factor * np.max(targetDQN.predict(nextstate_array), axis=1) * ~done_array
